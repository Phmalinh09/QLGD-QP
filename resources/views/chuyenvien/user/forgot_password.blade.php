                ...
                <div class="loginbox">
                    ...
                    <div class="login-right">
                        <div class="login-right-wrap">
                            ...
                            <form action="{{route('chuyenvien.forgot-passwords')}}" method="post">
                                @csrf
                                @if ( Session::get('fail') )
                                ...
                                <div class="form-group mb-0">
                                    <button class="btn btn-primary primary-reset btn-block" type=""><a href="{{route('chuyenvien.login')}}" style="color: aliceblue;">Đăng nhập</a></button>
                                </div>
