...
@section('page_title','Thêm đợt học')
    ...
    <div class="row align-items-center">
        <div class="col">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Thêm đợt học</li>
            </ul>
        </div>
    </div>
</div>
                ...
                <form method="POST" action="{{route('dothoc.store')}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-3">
                            <div class="form-group local-forms">
                                <label>Đợt <span class="login-danger">*</span></label>
                                <input type="text" class="form-control" value="{{old('sodot_text')}}" name="sodot_text">
                            </div>
                        </div>
                        <div class="col-12 col-sm-3">
                            <div class="form-group local-forms">
