        ...
        <div class="row">
            ...
            <div class="col-lg-1">
                <div class="search-student-btn1">
                    <a class="btn btn-primary" href="{{url('admin/phong')}}"><i class="fa fa-undo"></i></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-12">
        <div class="card card-table comman-shadow">
            <div class="card-body">
                ...
                <form action="{{ route('xoa-phong-o') }}" method="POST">
                    @method('DELETE')
                    @csrf
                        ...
                        <table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped " style=" white-space: normal;">
                                ...
                                <tr>
                                    <th>
                                        <div class="form-check check-tables">
                                            <input class="form-check-input" type="checkbox" name="xoa_tat_ca_phong_o" value="1">
                                        </div>
                                    </th>
                                    <th>STT</th>
                                    <th>Tên phòng</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-check check-tables">
                                            <input class="form-check-input" type="checkbox" name="phong_ids[]" value="{{ $phongs->id }}">
                                        </div>
                                    </td>
                                    ...
                                    <td class="text-end">
                                        <div class="actions">
                                            <a href="{{route('phong.edit',[$phongs->id])}}" class="btn btn-sm bg-danger-light">
                                                <i class="feather-edit"></i>
                                            </a>

                                            <form action="{{route('phong.destroy',[$phongs->id])}}" method="POST" style="margin-top:-4px;">
                                                @method('DELETE')
                                                @csrf
