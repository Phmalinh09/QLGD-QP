    ...
    <!-- <div class="col-md-12">
        <div class="profile-header">
            <div class="row align-items-center">
                <div class="col-auto profile-image">
                    <a href="#">
                        <img class="rounded-circle" width="150" height="150" alt="User Image" src="{{(!empty($editData->hinhanh))? url('upload/admin_image/'.$editData->hinhanh):url('upload/admin_image/images.png')}}">
                    </a>
                </div>
                <div class="col ms-md-n2 profile-user-info">
                    <h4 class="user-name mb-0">{{Auth::guard('admin')->user()->name}}</h4>
                    <h6 class="text-muted">{{Auth::guard('admin')->user()->vaitro}}</h6>
                    <div class="user-Location"><i class="fas fa-map-marker-alt"></i> {{Auth::guard('admin')->user()->diachi}}</div>
        ...
        <div class="profile-menu">
            <ul class="nav nav-tabs nav-tabs-solid">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="tab" href="#password_tab">Mật khẩu</a>
                </li>
            </ul>
        </div> -->
    <div class="">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title d-flex justify-content-between mb-sm-3">
                                ...
                                <a class="edit-link" data-bs-toggle="" href="{{route('admin.profile')}}"><i class="fas fa-reply-all"></i> Quay lại</a>
                            </h5>
