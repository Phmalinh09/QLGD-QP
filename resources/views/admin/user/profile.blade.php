...
<div class="page-header">
    <div class="row">
        <div class="col">
            <h3 class="page-title1">THÔNG TIN TÀI KHOẢN</h3>
        ...
        <div class="profile-header">
            <div class="row align-items-center">
                <div class="col-auto profile-image">
                    <a href="#">
                        <img class="rounded-circle" alt="User Image" src="{{(!empty($adminData->hinhanh))? url('upload/admin_image/'.$adminData->hinhanh):url('upload/admin_image/images.png')}}">
                    </a>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="card-title d-flex justify-content-between mb-sm-5">
                                    ...
                                    <a class="edit-link" data-bs-toggle="" href="{{route('admin.edit.profile')}}"><i class="far fa-edit me-1"></i>Sửa</a>
                                </h5>
