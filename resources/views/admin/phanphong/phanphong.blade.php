    ...
    <div class="student-group-form">
        <div class="row">
            ...
            <div class="col-lg-2 col-md-6">
                <div class="form-group">
                    <input type="text" name="ms_sv" id="ms_sv" value="{{ request('ms_sv') }}" class="form-control" placeholder="Tìm kiếm tên sv...">
                </div>
            </div>
            <div class="col-lg-2 col-md-6">
                <div class="form-group">
            ...
            <div class="col-lg-1">
                <div class="search-student-btn1">
                    <a class="btn btn-primary" href="{{url('admin/phanphong')}}"><i class="fa fa-undo"></i></a>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{route('phanphong.store')}}">
                    @csrf
                    <div class="row">
                        <div class="col-12">
        ...
        <div class="col-sm-12">
            <div class="card card-table comman-shadow">
                <div class="card-body">
                    ...
                    <form action="{{ route('xoa-phan-phong-o') }}" method="POST">
                        @method('DELETE')
                        @csrf
                        <div class="table-responsive ">
                            ...
                            <table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped " style=" white-space: normal;">
                                    ...
                                    <tr>
                                        <th>
                                            <div class="form-check check-tables">
                                                <input class="form-check-input" type="checkbox" name="xoa_tat_ca_phan_phong" value="1">
                                            </div>
                                        </th>
                                        <th>STT</th>
                                        <th>Khóa học</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-check check-tables">
                                                <input class="form-check-input" type="checkbox" name="phanphong_ids[]" value="{{ $phanphongss->id }}">
                                            </div>
                                        </td>
