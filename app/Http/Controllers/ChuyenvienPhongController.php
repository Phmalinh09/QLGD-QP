...
class ChuyenvienPhongController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('chuyenvien.phong.phong')->with(compact('phong','sophong','gioitinh'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('chuyenvien.phong.sua')->with(compact('phongs'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('chuyenvien/cvphong')->with($notification); //trả về trang mà bn đã gửi dữ liệu cho database
    }
    ...
    public function cvxoaPhongo(Request $request)
    {
        if ($request->has('cvxoa_tat_ca_phong_o')) {
